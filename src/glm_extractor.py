"""GLM-4.5V Page Extractor with Schema Validation"""
...
class GLMPageExtractor:
    """Extract structured information from page images using GLM-4.5V"""
...
直接输出 JSON，不要任何解释。"""
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        ...
        self.reader = LMStudioVisionReader()
        
        logger.info("glm_page_extractor_initialized")
    ...
    def extract_drawing_page(self, image_path: str) -> Dict[str, Any]:
        ...
        logger.debug("glm_raw_output", output_preview=raw_output[:500] if raw_output else "EMPTY")
    ...
    def _validate_and_fix_json(self, raw_output: str, schema: Dict[str, Any]) -> Dict[str, Any]:
        ...
        Args:
            raw_output: Raw string output from GLM
        ...
        """
        if not raw_output:
            logger.warning("empty_glm_output")
